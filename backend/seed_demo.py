...
CANDIDATES: dict[str, list[tuple[str, str, str, int, int]]] = {
    "東區": [
        ...
        ("洪麗雲", "會長候選人", "以歡喜心結善緣", 0, 1),
        ("曾建豪", "會長候選人", "人間佛教，在地深耕", 1, 1),
        ("廖雅婷", "會長候選人", "青年接棒，活力傳承", 0, 1),
        ("賴俊宏", "會長候選人", "不忘初心，護持道場", 0, 1),
    ],
    "南區": [
        ("蔡婉君", "會長候選人", "和敬共處，法喜充滿", 1, 41),
        ("吳文雄", "會長候選人", "服務奉獻，廣結善緣", 0, 38),
        ("趙淑芬", "會長候選人", "同體大悲，無緣大慈", 0, 27),
        ("鄭淑惠", "會長候選人", "以慈心待人，以願力做事", 0, 1),
        ("謝志豪", "會長候選人", "文化教育，向下扎根", 1, 1),
        ("郭美玲", "會長候選人", "關懷長者，守望相助", 0, 1),
        ("高文彬", "會長候選人", "共修共學，同願同行", 0, 1),
    ],
    "西區": [
        ("郭信宏", "會長候選人", "青年當自強", 0, 48),
        ("李美華", "會長候選人", "婦女同心，關懷家庭", 1, 35),
        ("徐德安", "會長候選人", "穩健踏實", 0, 29),
        ("潘怡君", "會長候選人", "書香傳家，智慧領航", 0, 1),
        ("蘇建銘", "會長候選人", "腳踏實地，穩中求進", 1, 1),
        ("江美惠", "會長候選人", "以茶會友，以法相會", 0, 1),
        ("何宗翰", "會長候選人", "薪火相傳，世代共好", 0, 1),
    ],
    "北區": [
        ("周雅琳", "會長候選人", "慈悲為懷", 0, 33),
        ("許志明", "會長候選人", "推廣文教", 1, 28),
        ("蕭雅雯", "會長候選人", "歡喜服務，廣結善緣", 0, 1),
        ("羅志偉", "會長候選人", "團結一心，共成佛道", 1, 1),
        ("葉淑貞", "會長候選人", "慈悲喜捨，利他為先", 0, 1),
        ("莊明宏", "會長候選人", "同心協力，再創佳績", 0, 1),
    ],
    "中區": [
        ("楊惠芳", "會長候選人", "中道圓融", 0, 29),
        ("呂佳蓉", "會長候選人", "和諧共榮，法喜充滿", 0, 1),
        ("劉俊傑", "會長候選人", "勇於承擔，歡喜奉獻", 1, 1),
        ("蔡宜蓁", "會長候選人", "以教育點亮希望", 0, 1),
        ("周文傑", "會長候選人", "中道而行，圓融無礙", 0, 1),
    ],
}
