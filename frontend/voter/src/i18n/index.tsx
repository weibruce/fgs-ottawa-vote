...
export const LANGS: { value: Lang; label: string; short: string }[] = [
  { value: 'zh-Hant', label: '繁體中文', short: '繁體中文' },
  { value: 'zh-Hans', label: '简体中文', short: '简体中文' },
  { value: 'en', label: 'English', short: 'English' },
]
...
const zhHant: Dict = {
  ...
  'confirmed.divisionLabel': '所屬分會',
  'confirmed.proxyLabel': '代理投票',
  'confirmed.startVote': '開始投票',
  'confirmed.editData': '個人資料更新',
  'confirmed.viewVote': '查看我的投票',
  'confirmed.proxyVote': '委託票',
  'confirmed.viewCandidates': '查看候選人信息',
  ...
  'proxy.currentLabel': '我的信息',
  'proxy.targetNameLabel': '委託人姓名',
  'proxy.targetCardLabel': '委託人卡號',
  'proxy.submit': '提交',
  'proxy.errAlreadyVoted': '該會員已完成投票，無需重複投票',
  'proxy.errSameAsSelf': '不可代替自己投票',
  'proxy.confirmLine1': '我{name}（卡號：{no}），正在為以下會員進行投票',
  'proxy.confirmName': '委託人姓名：{name}',
  'proxy.confirmCard': '委託人卡號：{no}',
  'proxy.confirmDivision': '委託人所屬分區：{division}',
  ...
  // ── P3 選擇候選人 ──
  'choose.heading': '{division}幹部改選',
  'choose.voterLine': '投票人：{name} {no}',
  'choose.bannerLabel': '點擊頭像可查看候選人資料',
  ...
  'viewCandidates.heading': '{division}候選人信息',
  'viewCandidates.banner': '點擊查看候選人詳細資料',
  'viewCandidates.back': '返回',
  'edit.readonlyNote': '如果發現姓名或分會登記有誤，請聯繫渥太華佛光山相關負責人。',
  'edit.genderLabel': '性別',
  'edit.phoneLabel': '手機號',
  'edit.emailLabel': 'Email',
  'edit.addressLabel': '地址',
  'edit.genderPlaceholder': '請選擇',
  'edit.saved': '已更新個人資料',
...
const zhHans: Dict = {
  ...
  'confirmed.divisionLabel': '所属分会',
  'confirmed.proxyLabel': '代理投票',
  'confirmed.startVote': '开始投票',
  'confirmed.editData': '个人资料更新',
  'confirmed.viewVote': '查看我的投票',
  'confirmed.proxyVote': '委托票',
  'confirmed.viewCandidates': '查看候选人信息',
  ...
  'proxy.currentLabel': '我的信息',
  'proxy.targetNameLabel': '委托人姓名',
  'proxy.targetCardLabel': '委托人卡号',
  'proxy.submit': '提交',
  'proxy.errAlreadyVoted': '该会员已完成投票，无需重复投票',
  'proxy.errSameAsSelf': '不可代替自己投票',
  'proxy.confirmLine1': '我{name}（卡号：{no}），正在为以下会员进行投票',
  'proxy.confirmName': '委托人姓名：{name}',
  'proxy.confirmCard': '委托人卡号：{no}',
  'proxy.confirmDivision': '委托人所属分区：{division}',
  ...
  'choose.heading': '{division}干部改选',
  'choose.voterLine': '投票人：{name} {no}',
  'choose.bannerLabel': '点击头像可查看候选人资料',
  ...
  'viewCandidates.heading': '{division}候选人信息',
  'viewCandidates.banner': '点击查看候选人详细资料',
  'viewCandidates.back': '返回',
  'edit.readonlyNote': '如果发现姓名或分会登记有误，请联系渥太华佛光山相关负责人。',
  'edit.genderLabel': '性别',
  'edit.phoneLabel': '手机号',
  'edit.emailLabel': 'Email',
  'edit.addressLabel': '地址',
  'edit.genderPlaceholder': '请选择',
  'edit.saved': '已更新个人资料',
...
const en: Dict = {
  ...
  'confirmed.editData': 'Update my profile',
  'confirmed.viewVote': 'View my vote',
  'confirmed.proxyVote': 'Proxy vote',
  'confirmed.viewCandidates': 'View candidates',
  ...
  'edit.heading': 'Update my profile',
  ...
  'edit.submit': 'Save',
  'edit.back': 'Back',
  'proxy.heading': 'Proxy vote',
  'proxy.desc': 'Enter the member you are voting for. Their identity will be verified too.',
  'proxy.currentLabel': 'My information',
  'proxy.targetNameLabel': 'Voter name',
  'proxy.targetCardLabel': 'Voter membership no.',
  'proxy.submit': 'Submit',
  'proxy.errAlreadyVoted': 'This member has already voted',
  'proxy.errSameAsSelf': 'You cannot vote on behalf of yourself',
  'proxy.confirmLine1': 'I, {name} (no. {no}), am voting on behalf of:',
  'proxy.confirmName': 'Voter name: {name}',
  'proxy.confirmCard': 'Voter membership no.: {no}',
  'proxy.confirmDivision': 'Voter division: {division}',
  ...
  'choose.heading': '{division} Officer Election',
  'choose.voterLine': 'Voter: {name} {no}',
  'choose.bannerLabel': 'Tap a photo to view candidate details',
  ...
  'viewCandidates.heading': '{division} Candidates',
  'viewCandidates.banner': 'Tap a candidate to see full details',
  'viewCandidates.back': 'Back',
  'edit.readonlyNote': 'If your name or division is incorrect, please contact the BLIA Ottawa officer in charge.',
  'edit.genderLabel': 'Gender',
  'edit.phoneLabel': 'Mobile',
  'edit.emailLabel': 'Email',
  'edit.addressLabel': 'Address',
  'edit.genderPlaceholder': 'Please select',
