...
const zhHant: Dict = {
  ...
  'choose.bannerLabel': '請選擇候選人，點擊頭像查看候選人資料',
  ...
  'edit.readonlyNote': '以下三項為會員登記資料，無法修改。',
  'edit.genderLabel': '性別',
  'edit.phoneLabel': '手機號',
...
const zhHans: Dict = {
  ...
  'choose.voterLine': '投票人：{name} {no}',
  'choose.bannerLabel': '请选择候选人，点击头像查看候选人资料',
  ...
  'viewCandidates.back': '返回',
  'edit.readonlyNote': '以下三项为会员登记资料，无法修改。',
  'edit.genderLabel': '性别',
  'edit.phoneLabel': '手机号',
  'edit.emailLabel': 'Email',
  'edit.addressLabel': '地址',
...
const en: Dict = {
  ...
  'choose.bannerLabel': 'Please select candidates — tap a photo for details',
  ...
  'edit.readonlyNote': 'These three fields are on record and cannot be changed.',
