...
const zhHant: Dict = {
  ...
  'confirmed.startVote': '開始{division}投票',
  // 代投成功提示（第 3 點）
...
const zhHans: Dict = {
  ...
  'verify.cardLabel': '佛光会员卡号',
  'verify.cardPlaceholder': '例：FGS-2026-0819',
  'verify.proxyLabel': '是否由他人代理投票',
  'verify.proxyNameLabel': '代投人姓名',
  'verify.proxyCardLabel': '代投人佛光会员卡号',
  'verify.submit': '确认身份资料',
  ...
  'confirmed.proxyLabel': '代理投票',
  'confirmed.startVote': '开始{division}投票',
...
const en: Dict = {
  ...
  'verify.cardLabel': 'BLIA membership no.',
  ...
  'confirmed.startVote': 'Start voting in {division}',
